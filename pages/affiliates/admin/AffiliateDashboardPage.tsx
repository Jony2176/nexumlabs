...
const RevenueChart = () => (
    <Card>
      <div className="p-6">
        <h3 className="text-lg font-semibold theme-text-primary mb-4">Revenue por Afiliados (Últimos 7 meses)</h3>
        <div className="h-80">
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <StatsCard title="Revenue (Este Mes)" value={renderPriceValue(revenuePrice, isRevenueLoading)} icon={<DollarSign />} change={15.3} />
        ...
        <div className="lg:col-span-1">
             <Card>
                <div className="p-5 flex flex-col items-center justify-center h-full">
                    ...
                    <h3 className="text-sm font-medium theme-text-secondary truncate mt-2">Top Afiliado del Mes</h3>
