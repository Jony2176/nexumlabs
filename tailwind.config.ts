// FIX: Converted to an ES module to resolve the "Cannot find name 'module'" error.
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'glow': {
            '0%, 100%': { textShadow: '0 0 10px rgba(14, 165, 233, 0.3), 0 0 20px rgba(14, 165, 233, 0.2)' },
            '50%': { textShadow: '0 0 20px rgba(14, 165, 233, 0.5), 0 0 30px rgba(14, 165, 233, 0.4)' },
        },
        slideIn: {
