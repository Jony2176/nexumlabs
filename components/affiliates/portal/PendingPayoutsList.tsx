...
const statusInfo = {
    pending: { text: 'Pendiente', icon: Clock, className: 'text-yellow-500 bg-yellow-100 dark:bg-yellow-900/50' },
    approved: { text: 'Aprobado', icon: CheckCircle, className: 'text-green-500 bg-green-100 dark:bg-green-900/50' }
};
        ...
        {requests.length === 0 ? (
          ...
          <ul className="space-y-3">
            {requests.map(req => {
                ...
                return (
                    <li key={req.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                        <div>
